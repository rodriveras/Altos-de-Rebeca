...
map.getView().fit([-8019537.087519, -4395234.229971, -8017910.082904, -4394221.733924], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Fundo Altos de Rebeca</h2>';
        return titleElement;
    })(),
